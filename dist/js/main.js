			...
			$(form_wrap).on('submit','form',function(event) {
				...
				$.ajax({
						...
						complete: function(){
							...
							if(id === '#modal') {yaCounter248.reachGoal('bez-kred-callback1');}
							if(id === '#feedback1') {yaCounter248.reachGoal('bez-kred-form1');}
							if(id === '#feedback2') {yaCounter248.reachGoal('bez-kred-form2');}
							if(id === '#feedback3') {yaCounter248.reachGoal('bez-kred-form3');}
							if(id === '#feedback4') {yaCounter248.reachGoal('bez-kred-form4');}
						}
				})
